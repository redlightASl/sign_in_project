...
#ifndef AI_YOLOFACE_H
#define AI_YOLOFACE_H
#pragma once
...
/******************************************************************************/
#define AI_YOLOFACE_MODEL_NAME          "yoloface"
#define AI_YOLOFACE_ORIGIN_MODEL_NAME   "yoloface_int8"

/******************************************************************************/
#define AI_YOLOFACE_ACTIVATIONS_ALIGNMENT   (4)



/******************************************************************************/
#define AI_YOLOFACE_IN_NUM        (1)

AI_DEPRECATED
#define AI_YOLOFACE_IN \
  ai_yoloface_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_YOLOFACE_IN_SIZE { \
  AI_YOLOFACE_IN_1_SIZE, \
}
#define AI_YOLOFACE_IN_SIZE_BYTES { \
  AI_YOLOFACE_IN_1_SIZE_BYTES, \
}
#define AI_YOLOFACE_IN_1_HEIGHT      (56)
#define AI_YOLOFACE_IN_1_WIDTH       (56)
#define AI_YOLOFACE_IN_1_CHANNEL     (3)
#define AI_YOLOFACE_IN_1_SIZE        (56 * 56 * 3)
#define AI_YOLOFACE_IN_1_SIZE_BYTES  (9409)

/******************************************************************************/
#define AI_YOLOFACE_OUT_NUM       (1)

AI_DEPRECATED
#define AI_YOLOFACE_OUT \
  ai_yoloface_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_YOLOFACE_OUT_SIZE { \
  AI_YOLOFACE_OUT_1_SIZE, \
}
#define AI_YOLOFACE_OUT_SIZE_BYTES { \
  AI_YOLOFACE_OUT_1_SIZE_BYTES, \
}
#define AI_YOLOFACE_OUT_1_HEIGHT      (7)
#define AI_YOLOFACE_OUT_1_WIDTH       (7)
#define AI_YOLOFACE_OUT_1_CHANNEL     (18)
#define AI_YOLOFACE_OUT_1_SIZE        (7 * 7 * 18)
#define AI_YOLOFACE_OUT_1_SIZE_BYTES  (882)

/******************************************************************************/
#define AI_YOLOFACE_N_NODES (31)
 ...
 */
AI_API_ENTRY
ai_bool ai_yoloface_get_report(
  ai_handle network, ai_network_report* report);
 ...
 */
AI_API_ENTRY
ai_error ai_yoloface_get_error(ai_handle network);
 ...
 * using @ref ai_yoloface_get_error
 */
AI_API_ENTRY
ai_bool ai_yoloface_init(
 ...
 */
AI_API_ENTRY
ai_error ai_yoloface_create_and_init(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_yoloface_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_yoloface_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_YOLOFACE_*
 * defines into file @ref yoloface.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
